...
const {obtenerPrograma} = require('../modelos/mostrarProgramaModelo.js');
/*Definimos el controlador de express: En controladores/mostrarProgramaControlador.js
...
const mostrarPrograma = (req, res) =>{
	obtenerPrograma((err, resultados)=>{
		if(err){
			return res.status(500).json({error: 'Hubo un error al obtener ls datos del programa'});
		}
